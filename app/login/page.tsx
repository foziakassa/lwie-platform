...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Perform custom validation checks for email and password
        ...
        try {
            ...
            const userData = {
              email: data.Email,
              password: data.Password, // Typically, storing passwords directly is not recommended for security reasons.
            ...
            if (data) {
                // Set authentication cookies based on remember me preference
                const cookieMaxAge = rememberMe ? 30 * 24 * 60 * 60 : 24 * 60 * 60; // 30 days or 1 day
                Cookies.set('authToken',JSON.stringify(userData), { expires: cookieMaxAge }); // Set your auth token here

  ...
  useEffect(() => {
    ...
    if (tokenString) {
      try {
        ...
        setUserInfo({ ...parsedToken, ...mockUserData })
        setIsLoggedIn(true)
      } catch (error) {
        // If it's not valid JSON, use it as a string
        setUserInfo({ token: tokenString, ...mockUserData })
        setIsLoggedIn(true)
        console.log("Using token as string:", tokenString)
      }
    } else {
      setUserInfo(null)
      setIsLoggedIn(false)
                      ...
                      <div className="p-4 bg-gradient-to-r from-teal-500 to-teal-600 dark:from-teal-700 dark:to-teal-800">
                        ...
                        <div className="flex justify-between mt-4 text-white text-sm">
                          ...
                          {/* <div className="text-center">
                            ...
                            <p className="text-teal-100">Rating</p>
                          </div> */}
                        </div>
                      </div>

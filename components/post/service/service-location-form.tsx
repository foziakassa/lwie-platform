...
const formSchema = z.object({
  ...
  serviceArea: z.string({
    required_error: "Please select your service area.",
  }),
})
...
export default function ServiceLocationForm() {
  ...
  const saveDraft = () => {
    ...
    localStorage.setItem("serviceLocationDraft", JSON.stringify(values))
    toast({
      title: "Draft saved",
  ...
  const serviceAreas = [
    "Within my subcity only",
    "Anywhere in my city",
    "Up to 25km from my location",
    "Up to 50km from my location",
    "Nationwide",
    "Remote/Online only",
  ]
    ...
    >
      <div className="mb-6">
        <div className="flex items-center mb-2">
          ...
          <h2 className="text-2xl font-bold text-[#00796B]">Service Location</h2>
        </div>
        <p className="text-gray-600">Where do you provide your service?</p>
      </div>
